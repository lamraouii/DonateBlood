 ...
 */
final class Version20260107135029 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__donor_profile AS SELECT id, blood_type, birthdate, phone_number, cine, user_id FROM donor_profile');
        $this->addSql('DROP TABLE donor_profile');
        $this->addSql('CREATE TABLE donor_profile (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, blood_type VARCHAR(4) NOT NULL, birthdate DATE DEFAULT NULL, phone_number VARCHAR(20) DEFAULT NULL, cine VARCHAR(10) NOT NULL, user_id INTEGER NOT NULL, CONSTRAINT FK_F7DE98B8A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO donor_profile (id, blood_type, birthdate, phone_number, cine, user_id) SELECT id, blood_type, birthdate, phone_number, cine, user_id FROM __temp__donor_profile');
        $this->addSql('DROP TABLE __temp__donor_profile');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F7DE98B88977A4A0 ON donor_profile (cine)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F7DE98B8A76ED395 ON donor_profile (user_id)');
